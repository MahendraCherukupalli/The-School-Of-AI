    ...
    try:
        ...
        async with stdio_client(server_params) as (read, write):
            ...
            async with ClientSession(read, write) as session:
                ...
                system_prompt = """You are a calculator assistant that helps with mathematical operations.

                For any calculation task:
                1. First convert text input to numeric values
                2. Then perform the mathematical calculation on those values
                3. Finally send the results via email
                
                Important:
                - Complete all steps in sequence
                - Each step must use the result from the previous step
                - Include both input and final result in the email
                - Stop after sending the email
                ...
                Discover the appropriate functions by checking the available tools.
                Do not add any explanations or extra text in your responses."""
...
Query: {current_query}"""
                    ...
                    if response_text.startswith("FUNCTION_CALL:"):
                        ...
                        try:
                            ...
                            # Add recipient_email to arguments
