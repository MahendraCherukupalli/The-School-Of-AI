...
async def run_python_sandbox(code: str, dispatcher: Any, fetched_content_for_summary: str | None = None) -> str:
    ...
    try:
        ...
        if fetched_content_for_summary is not None:
            sandbox.__dict__["fetched_content"] = fetched_content_for_summary # Make content available
